defmodule VirtualCryptoWeb.Api.Interactions.Claim do
  import VirtualCryptoWeb.Api.Interactions.Util
  import VirtualCryptoWeb.Api.Interactions.Claim.Common
  alias VirtualCryptoWeb.Api.Interactions.Claim.Show
  ...
  def render({:ok, subcommand, m})
    ...
    VirtualCryptoWeb.Api.Interactions.Claim.Listing.render(subcommand, m)
  end
