defmodule VirtualCryptoWeb.Oauth2Controller do
  ...
  alias VirtualCryptoWeb.Oauth2Controller.Validater
  ...
  def register_get(conn, _params) do
    ...
    case params do
      {:ok, %{application: application, redirect_uris: redirect_uris, user: user}} ->
        render(conn, "info.register.json", application: application, redirect_uris: redirect_uris,user: user)
